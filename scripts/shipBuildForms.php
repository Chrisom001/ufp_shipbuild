...
//        $form .= "</div>";
        $form .= "<ul class='nav nav-tabs' id='myTab' role='tablist'>";
        $form .= "<li class='nav-item' role='presentation'>";
        $form .= "<button class='nav-link active' id='weapons-tab' data-bs-toggle='tab' data-bs-target='#weapons' type='button' role='tab' aria-controls='weapons' aria-selected='true'>Weapons</button>";
        $form .= "</li>";
        $form .= "<li class='nav-item' role='presentation'>";
        $form .= "<button class='nav-link' id='console-tab' data-bs-toggle='tab' data-bs-target='#console' type='button' role='tab' aria-controls='console' aria-selected='false'>Consoles</button>";
        $form .= "</li>";
        $form .= "<li class='nav-item' role='presentation'>";
        ...
        $form .= "</li>";
        $form .= "<li class='nav-item' role='presentation'>";
        $form .= "<button class='nav-link' id='finaloptions-tab' data-bs-toggle='tab' data-bs-target='#finaloptions' type='button' role='tab' aria-controls='finaloptions' aria-selected='false'>Final Selections</button>";
        $form .= "</li>";
        $form .= "</ul>";

        $form .= "<div class='tab-content'>";
        $form .= "<div class='tab-pane active' id='weapons' role='tabpanel' aria-labelledby='weapons-tab'>".addShipWeps($shipID)."</div>";
        $form .= "<div class='tab-pane' id='console' role='tabpanel' aria-labelledby='console-tab'>".shipConsoleAdd($shipID)."</div>";
        $form .= "<div class='tab-pane' id='equipment' role='tabpanel' aria-labelledby='equipment-tab'>...</div>";
        $form .= "<div class='tab-pane' id='finaloptions' role='tabpanel' aria-labelledby='finaloptions-tab'>".finalBasicDetails($shipID)."</div>";
        $form .= "</div>";
        return $form;
    }
